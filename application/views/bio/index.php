<div class="container">
	<div class="row">
		<div class="col-lg-4">			
			...
			<img src="<?php base_url()?>public/images/Bio2.jpg" class="card-img-top" alt="...">	
		</div>
		<div class="col-lg-8">
			<p>Horror fiction author H.P. Lovecraft wrote short stories, novels and novellas, including "The Call of Cthulhu" and The Case of Charles Dexter Ward.
Synopsis
